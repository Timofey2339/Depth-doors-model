coroutine.wrap(function()
    while true do
        ...
        if workspace:FindFirstChild("SeekMovingNewClone") or workspace.CurrentRooms:FindFirstChild("50") then
            game.Workspace:FindFirstChild("Glacher", 5):Destroy()
			return
        end
    end
end)()
...
local entity = spawner.Create({
        Entity = {
            Name = "Glacher",
            Asset = "rbxassetid://75933370832645",
            HeightOffset = 0
        },
        Lights = {
        ...
        CameraShake = { Enabled = true, Range = 100, Values = {0.3, 0.1, 0.2, 0.15} },
                Jumpscare = {
            false, -- Enabled
            {
...
scare.SoundId = "rbxassetid://5263560896"
