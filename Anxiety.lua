coroutine.wrap(function()
    while true do
        ...
        if workspace:FindFirstChild("SeekMovingNewClone") or workspace.CurrentRooms:FindFirstChild("50") then
            game.Workspace:FindFirstChild("Anxiety"):Destroy()
			return
        end
    end
end)()
...
local entity = spawner.Create({
        Entity = {
            Name = "Anxiety",
            Asset = "rbxassetid://121666697064953",
            HeightOffset = 0
        },
        Lights = {
            Flicker = { Enabled = true, Duration = 4},
            Shatter = true, Repair = true
        },
        Earthquake = { Enabled = true },
        CameraShake = { Enabled = true, Range = 100, Values = {0.2, 0.3, 0.1, 0.2} },
                Jumpscare = {
            false, -- Enabled
            {
        ...
        Rebounding = { Enabled = true, Type = "Ambush", Min = 1, Max = 3, Delay = 3.0 },
...
Sound.SoundId = "rbxassetid://9114224217"
Sound.Volume = 6
...
wait(5)
        ...
        local model = game.Workspace:FindFirstChild("Anxiety")
        if model then
...
for v5 = 1, 70 do
	...
	if v6 == 1 then
		Background.BackgroundColor3 = Color3.new(1, 0.666667, 0)
	...
	if v6 == 3 then
		Background.BackgroundColor3 = Color3.new(0.454902, 0.301961, 0)
		Face.ImageColor3 = Color3.new(0.490196, 0.490196, 0.490196)
	end
	Face.Position = UDim2.new(v2:NextNumber(0.4, 0.6), 0,v2:NextNumber(0.4, 0.6), 0)
	Face.Size = Face.Size + UDim2.new(SizeValue.Value / 999, 0, 0.001, 0)
	Face.Rotation = math.random(-20, 20)
	SizeValue.Value = SizeValue.Value + 0.3
	wait(0)
		end
