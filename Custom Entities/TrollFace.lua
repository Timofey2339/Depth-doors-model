...
local entity = spawner.Create({
        Entity = {
            Name = "Trollface",
            Asset = "rbxassetid://110069417932717",
            HeightOffset = 0
        },
        Lights = {
        ...
        CameraShake = { Enabled = true, Range = 100, Values = {5, 5, 1, 1} },
        ...
        Death = {
            Type = "Guiding",
            Hints = {"You died by Trollface", "You been trolled", "lol","Bye Bye"}, 
            Cause = "Trollface"
        }
    })
...
wait(5)
        ...
        local model = game.Workspace:FindFirstChild("Trollface")
        if model then
