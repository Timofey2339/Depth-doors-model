...
local entity = spawner.Create({
        Entity = {
            Name = "A-25 Rooms But Doors",
            Asset = "rbxassetid://113737004126473",
            HeightOffset = 0
        },
        Lights = {
        ...
        Death = {
            Type = "Guiding",
            Hints = {"You died by A-25", "If the light starts to flicker", "hide","Bye Bye"}, 
            Cause = "A-25 Rooms But Doors"
        }
    })
...
wait(5)
        ...
        local model = game.Workspace:FindFirstChild("A-25 Rooms But Doors")
        if model then
